...
@.str.1 = private unnamed_addr constant [13 x i8] c"It depends!\0A\00", align 1
@.str.2 = private unnamed_addr constant [30 x i8] c"What is the meaning of life?\0A\00", align 1
...
8:                                                ; preds = %2
  ...
  %12 = call i32 @strcmp(i8* %11, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0)) #4
  %13 = icmp eq i32 %12, 0
